<%@ Page Title="Kullanıcı Profili" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="Kullanici.aspx.cs"
    Inherits="Cinescope.Kullanici" %>
...
<div class="hesap-profil-card">
    ...
    <div style="flex:1;display:flex;justify-content:space-between;">
        <div>
            <h2><asp:Label ID="lblKullaniciAdi" runat="server" /></h2>

            <span class="hesap-chip">
                <a href='Takipci.aspx?id=<%= Request.QueryString["id"] %>'>
                    <asp:Label ID="lblTakipci" runat="server" /> Takipçi
                </a>
            </span>

            <span class="hesap-chip">
                <a href='Takipedilen.aspx?id=<%= Request.QueryString["id"] %>'>
                    <asp:Label ID="lblTakipEdilen" runat="server" /> Takip Edilen
                </a>
            </span>
        </div>

        <div class="hesap-btn-group">
            <asp:Button ID="btnTakip" runat="server" CssClass="hesap-btn"
                Text="Takip Et" OnClick="btnTakip_Click" />
            <asp:Button ID="btnMesaj" runat="server" CssClass="hesap-btn hesap-btn-outline"
                Text=" Mesaj Gönder" OnClick="btnMesaj_Click" />
            <asp:Button ID="btnOrtakListe" runat="server"
    CssClass="hesap-btn"
    Text="Ortak Liste Oluştur"
    OnClick="btnOrtakListe_Click" />
...
<div class="hesap-hakkimda-wide">
    <asp:Label ID="lblHakkimda" runat="server" />
</div>

<div class="istatistik-wrapper">
    <div class="istatistik-card"><asp:Label ID="lblFilmSayisi" runat="server" CssClass="istatistik-number"/><div class="istatistik-text">Film</div></div>
    <div class="istatistik-card"><asp:Label ID="lblDiziSayisi" runat="server" CssClass="istatistik-number"/><div class="istatistik-text">Dizi</div></div>
    <div class="istatistik-card"><asp:Label ID="lblListeSayisi" runat="server" CssClass="istatistik-number"/><div class="istatistik-text">Liste</div></div>
    <div class="istatistik-card"><asp:Label ID="lblRozet" runat="server" CssClass="istatistik-number"/><div class="istatistik-text">Rozet</div></div>
</div>

<div class="two-col-layout">
    <div class="left-col">
        <div class="box">
            <h3 class="section-title"><span>Son İzlediği Filmler</span></h3>
        ...
        <div class="box">
            <h3 class="section-title"><span>Son İzlediği Diziler</span></h3>
        ...
        <div class="box">
            <h3 class="section-title"><span>Listeler</span></h3>
    ...
    <div class="right-col">
        <div class="box">
            <h3 class="section-title"><span>Son Film Eleştirileri</span></h3>
        ...
        <div class="box">
            <h3 class="section-title"><span>Son Dizi Eleştirileri</span></h3>
            <div class="elestiri-container">
