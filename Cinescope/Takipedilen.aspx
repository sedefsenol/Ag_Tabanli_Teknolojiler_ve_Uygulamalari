<%@ Page Title="Takip Edilenler" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="TakipEdilenler.aspx.cs"
    Inherits="Cinescope.TakipEdilenler" %>
...
<div class="takipci-wrapper">
    ...
    <asp:Repeater ID="rptTakipEdilenler" runat="server">
        <ItemTemplate>
