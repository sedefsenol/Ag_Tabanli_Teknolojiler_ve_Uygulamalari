<%@ Page Title="Favoriler" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="Favoriler.aspx.cs"
    Inherits="Cinescope.Favoriler" %>
...
<div class="tab-wrapper">
    ...
    <a href="Favoriler.aspx" class="tab-item active">Favoriler</a>
...
<div class="content-wrapper" id="favWrapper">

    <div id="filmArea" class="favori-row">
        <asp:Repeater ID="rptFavoriFilmler" runat="server"
            OnItemCommand="rptFavoriFilmler_ItemCommand">
            <ItemTemplate>
    ...
    <div id="diziArea" class="favori-row" style="display:none;">
        <asp:Repeater ID="rptFavoriDiziler" runat="server"
            OnItemCommand="rptFavoriDiziler_ItemCommand">
            <ItemTemplate>
                <div class="favori-item"
...
<script>
    ...
    function toggleEdit() {
        editMode = !editMode;
        document.getElementById("favWrapper")
